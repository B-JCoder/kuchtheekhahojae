      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto leading-relaxed">
            Don't just take our word for it. Here is what the Golgappa lovers of
            Karachi have to say about their experience.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          {testimonials.map((testimonial) => (
            <div
              key={testimonial.id}
              className="relative bg-white p-10 rounded-[2rem] shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300"
            >
