        ...
        <section className="py-24 bg-[#FAFAFA]">
            <div className="container mx-auto px-4 max-w-4xl">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-extrabold text-brand-dark mb-6 tracking-tight">Frequently Asked Questions</h2>
    ...
    return (
        ...
        >
            <div className="flex justify-between items-center gap-4">
                <h3 className={`font-bold text-lg transition-colors duration-300 ${isOpen ? "text-[#D32F2F]" : "text-brand-dark"}`}>
                    {q}
                </h3>
                <div className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-colors duration-300 ${isOpen ? "bg-red-100 text-[#D32F2F]" : "bg-gray-100 text-gray-500"}`}>
