  ...
  return (
    <section className="bg-white rounded-2xl shadow-sm p-8 md:p-12">
      ...
      <p className="text-gray-700 text-lg leading-relaxed mb-6 text-center">
        ...
        food. We wanted everyone to enjoy gol gappa without worrying about
        health.
      </p>
      <p className="text-gray-700 text-lg leading-relaxed text-center">
        Using mineral water, fresh ingredients, and premium packaging, we
        recreated authentic street taste in a clean, controlled kitchen
        environment.
      </p>
    </section>
  );
