  ...
  return (
    <div className="min-h-screen bg-brand-offwhite pb-20">
      <PageHero
        ...
        title="Contact"
        highlighted="Us"
        description="Have questions or want to place a bulk order? We’re just a message away."
        image="/bgremoveimages/2.png"
      />
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">
                      Plot 123, Block 5, Gulshan-e-Iqbal,
                      <br />
                      Karachi, Pakistan.
                    </p>
                  </div>
            ...
            <div className="bg-brand-yellow/10 p-6 rounded-xl border border-brand-yellow/20">
              ...
              <p className="text-gray-700 mb-4">
                We specialize in live Golgappa stalls for weddings and corporate
                events. Contact us directly on WhatsApp for customized packages.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    required
                    className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-brand-red outline-none"
        ...
        <div className="mt-20">
          ...
          <div className="bg-gray-200 w-full h-80 rounded-2xl flex items-center justify-center text-gray-500 font-bold text-xl relative overflow-hidden">
            ...
            <span className="relative z-10">
              Map Loading... (Delivering to all major areas in Karachi)
            </span>
          </div>
        </div>
      </div>
